...
{
    public abstract class IObstacle : IGrid, ICustomDataObstacle
    {
        ...
        protected IObstacle(IObstacle other)
        {
            Time = other.Time;
            PosX = other.PosX;
            PosY = other.PosY;
        ...
        protected IObstacle(float time, int posX, int type, float duration, int width,
        ...
        protected IObstacle(float time, int posX, int posY, float duration, int width, int height,
        ...
        protected IObstacle(float time, int posX, int posY, int type, float duration, int width, int height,
            JSONNode customData = null) : base(time, posX, posY, customData)
        {
            Type = type;
            Duration = duration;
        ...
        public override void Apply(IObject originalData)
        {
            ...
            if (originalData is IObstacle obstacle)
            {
