...
{
    public abstract class IArc : IBaseSlider, ICustomDataArc
    {
        protected IArc()
        {
        }

        protected IArc(IArc other)
        {
            Time = other.Time;
            Color = other.Color;
            PosX = other.PosX;
        ...
        protected IArc(INote start, INote end)
        {
            Time = start.Time;
            Color = start.Color;
            PosX = start.PosX;
        ...
        protected IArc(float time, int color, int posX, int posY, int cutDirection, int angleOffset,
