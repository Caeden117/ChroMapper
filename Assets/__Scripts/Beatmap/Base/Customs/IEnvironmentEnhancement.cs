...
{
    public abstract class IEnvironmentEnhancement : IItem
    {
        protected IEnvironmentEnhancement()
        {
        }

        protected IEnvironmentEnhancement(JSONNode node) => InstantiateHelper(ref node);

        protected IEnvironmentEnhancement(string toRemove)
        {
            ID = toRemove;
            Active = false;
        ...
        private bool Equals(IEnvironmentEnhancement other) =>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((IEnvironmentEnhancement)obj);
        }
