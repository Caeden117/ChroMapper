...
public class BeatmapArcInputController : BeatmapInputController<ArcContainer>, CMInput.IArcObjectsActions
{
    ...
    public void ChangeMu(ArcContainer s, float modifier)
    {
        ...
        BeatmapActionContainer.AddAction(new BeatmapObjectModifiedAction(s.ObjectData, s.ObjectData, original, mergeType: BeatmapObjectModifiedAction.MergeType.ArcHeadMultTweak));
    }
    ...
    public void ChangeTmu(ArcContainer s, float modifier)
    {
        ...
        s.NotifySplineChanged();
        BeatmapActionContainer.AddAction(new BeatmapObjectModifiedAction(s.ObjectData, s.ObjectData, original, mergeType: BeatmapObjectModifiedAction.MergeType.ArcTailMultTweak));
    }
}
