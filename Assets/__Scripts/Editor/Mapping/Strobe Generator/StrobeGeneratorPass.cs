...
{
    protected readonly TrackDefinitionsSO TrackDefinitions;

    protected StrobeGeneratorPass(TrackDefinitionsSO trackDefinitions) => TrackDefinitions = trackDefinitions;
