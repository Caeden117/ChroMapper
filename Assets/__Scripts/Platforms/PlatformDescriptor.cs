...
public class PlatformDescriptor : MonoBehaviour {
    ...
    public ITrackLaneRingsManager BigRingManager;
    ...
    public void EventPassed(bool initial, int index, BeatmapObject obj)
    {
        ...
        switch (e._type) { //FUN PART BOIS
            ...
            case 9:
                ...
                break;
            case 12:
                foreach (IRotatingLights l in LightingManagers[MapEvent.EVENT_TYPE_LEFT_LASERS].RotatingLights)
                    l.UpdateOffset(e._value, rng.Next(0, 180), rng.Next(0, 1) == 1, obj._customData);
                break;
            case 13:
                foreach (IRotatingLights r in LightingManagers[MapEvent.EVENT_TYPE_RIGHT_LASERS].RotatingLights)
